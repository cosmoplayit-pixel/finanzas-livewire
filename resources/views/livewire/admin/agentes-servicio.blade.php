...
<div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1 dark:text-neutral-400">
                Administración de agentes, asignación de cuentas e información de contacto.
            </p>
        </div>
        ...
        <div class="flex gap-2">
            @can('agentes_servicio.create')
                <button wire:click="openCreate" wire:loading.attr="disabled" wire:target="openCreate"
                    ...
                    <span wire:loading.remove wire:target="openCreate">Nuevo Agente</span>
    ...
    {{-- FILTROS --}}
    @php $activeFiltersCount = ($status !== 'active' ? 1 : 0) + (auth()->user()?->hasRole('Administrador') && $empresaFilter !== 'all' ? 1 : 0); @endphp
    <div x-data="{ openFilters: false }" class="relative mb-6">
                ...
                <div class="mt-2 space-y-3 px-4 pb-3 text-[13px]" x-show="openMobile" x-collapse x-cloak>
                    <div>
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search"
                            placeholder="Buscar Nombre, CI o Celular..." autocomplete="off"
        ...
        <div x-show="openFilters" x-cloak @click.outside="openFilters = false"
            ...
            wire:ignore.self wire:key="agentes-panel-filtros">
            ...
            <div class="border rounded-lg p-4 bg-white dark:bg-neutral-900 dark:border-neutral-800">
                ...
                <div class="mt-3 grid grid-cols-1 gap-2 text-sm">
                    <div class="flex justify-between gap-3">
                        ...
                        <span class="font-medium">{{ $agentes->firstItem() + $loop->index }}</span>
                    </div>
                ...
                <tbody wire:key="agente-{{ $a->id }}" x-data="{ open: false }"
                    ...
                    <tr class="hover:bg-slate-50/50 dark:hover:bg-neutral-900/40 transition-colors">
                        ...
                        <td class="p-1 whitespace-nowrap text-center" x-data="{ showToggle: !window.matchMedia('(min-width: 1280px)').matches }"
                            ...
                            <span class="ml-1">{{ $agentes->firstItem() + $loop->index }}</span>
                        </td>
