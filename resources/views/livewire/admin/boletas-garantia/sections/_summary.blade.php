...
@endphp
<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-3">
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1.5 sm:mb-3 leading-tight">Total Emitido ({{ $dateLabel }})</p>
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1.5 sm:mb-3 leading-tight">Total Devuelto ({{ $dateLabel }})</p>
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1.5 sm:mb-3 leading-tight">Saldo ({{ $historicalLabel }})</p>
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1 sm:mb-2 leading-tight">Boletas Registradas
            ({{ $historicalLabel }})</p>
