...
<div>
    ...
    <div x-data="{ openFilters: false }" class="relative mb-6">
                ...
                <div class="mt-2 space-y-3 px-4 pb-3 text-[13px]" x-show="openMobile" x-collapse x-cloak>
                    <div>
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search"
                            placeholder="Buscar Nombre o Correo..." autocomplete="off"
        ...
        <div x-show="openFilters" x-cloak @click.outside="openFilters = false"
            ...
            wire:ignore.self wire:key="entidades-panel-filtros">
            ...
            <div wire:key="entidad-card-{{ $e->id }}" x-data="{ showFullNombre: false }"
                ...
                <div class="mt-3 grid grid-cols-1 gap-2 text-sm">
                    <div class="flex justify-between gap-3">
                        ...
                        <span class="font-medium">{{ $entidades->firstItem() + $loop->index }}</span>
                    </div>
                ...
                <tbody x-data="{ open: false, showFullNombre: false }" class="divide-y divide-gray-200 dark:divide-neutral-200">
                    ...
                    <tr wire:key="entidad-row-{{ $e->id }}"
                        ...
                        <td class="p-1 whitespace-nowrap text-center" x-data="{ showToggle: !window.matchMedia('(min-width: 1536px)').matches }"
                            ...
                            <span
                                class="ml-1">{{ ($entidades->currentPage() - 1) * $entidades->perPage() + $loop->iteration }}</span>
                        </td>
