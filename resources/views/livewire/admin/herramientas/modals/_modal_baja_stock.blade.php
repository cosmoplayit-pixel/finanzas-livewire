    ...
    <x-ui.modal wire:key="baja-stock-modal" model="openBajaStockModal" title="Baja de Stock" maxWidth="sm:max-w-xl"
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div
                    ...
                    <div class="text-2xl font-black text-red-600 dark:text-red-400 font-mono">
                        {{ max(0, $bajaStockActual - (int) $bajaStockCantidad) }}</div>
                </div>
            </div>
        ...
        @slot('footer')
            <div class="w-full grid grid-cols-2 gap-2">
                ...
                <button type="button" wire:click="saveBajaStock" wire:loading.attr="disabled" @disabled(!$bajaStockCantidad || $bajaStockCantidad <= 0 || !$bajaStockObservaciones)
