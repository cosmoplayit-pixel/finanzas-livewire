...
<div x-data="{ openFilters: false }" class="relative mb-6">
            ...
            <div class="mt-2 space-y-3 px-4 pb-3 text-[13px]" x-show="openMobile" x-collapse x-cloak>
                <div>
                    ...
                    <input type="text" wire:model="search" wire:keydown.enter="$refresh"
                        wire:blur.debounce.1000ms="$refresh" placeholder="Buscar Código de Inversión..."
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="block mb-1 text-gray-600 dark:text-neutral-300 text-[13px]">Tipo</label>
                        <select wire:model.live="fTipo"
                            class="w-full cursor-pointer rounded-lg border px-3 py-2 bg-white dark:bg-neutral-900 border-gray-300 dark:border-neutral-700 text-gray-900 dark:text-neutral-100 text-[13px] focus:outline-none focus:ring-2 focus:ring-gray-500/40">
    ...
    <div x-show="openFilters" x-cloak @click.outside="openFilters = false" @keydown.escape.window="openFilters = false"
        ...
        wire:ignore.self wire:key="inversiones-panel-filtros">
