...
<div class="md:hidden space-y-2">
    @forelse ($inversiones as $inv)
        ...
        <div class="rounded-2xl border border-gray-200 dark:border-neutral-700 overflow-hidden {{ $cardBg }}">
            ...
            <div class="px-3 pt-2 pb-1.5">
                <div class="flex items-start justify-between gap-2">
                    ...
                    <div class="shrink-0">
                        @if ($utilPendiente)
                            <span
                                class="inline-flex items-center gap-1 px-1.5 py-1 rounded-lg
                                         bg-amber-100 text-amber-700
                                         dark:bg-amber-900/30 dark:text-amber-300 text-[10px] font-semibold">
                                {{-- icon clock --}}
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                            ...
                            @if ($inv->estado === 'ACTIVA')
                                <span
                                    class="inline-flex items-center gap-1 px-1.5 py-1 rounded-lg
                                             ...
                                             dark:bg-emerald-900/30 dark:text-emerald-300 text-[10px] font-semibold">
                                    {{-- icon check --}}
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            @else
                                <span
                                    class="inline-flex items-center gap-1 px-1.5 py-1 rounded-lg
                                             ...
                                             dark:bg-neutral-700 dark:text-neutral-200 text-[10px] font-semibold">
                                    {{-- icon lock --}}
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round">
            ...
            {{-- BODY --}}
            <div class="px-2 pb-2.5 space-y-2.5">

                {{-- Banco box --}}
                <div
                    class="rounded-xl border border-gray-200 dark:border-neutral-700 bg-white/70 dark:bg-neutral-900/40 px-2.5 py-2">
                    <div class="flex items-start gap-2">
                        {{-- Contenido --}}
                        <div class="min-w-0 flex-1">
                            {{-- Nombre banco --}}
                            <div
                                class="flex items-center text-[12px] font-semibold text-gray-900 dark:text-neutral-100 truncate">
                                {{-- Icono banco --}}
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="w-3.5 h-3.5 mt-0.5 shrink-0 text-gray-700 dark:text-neutral-200"
                            ...
                            {{-- Cuenta + Moneda (compacto) --}}
                            <div class="mt-0.5 min-w-0 text-[10px] text-gray-500 dark:text-neutral-400 leading-none">
                ...
                {{-- Fechas + acciones --}}
                <div
                    class="rounded-xl border border-gray-200 dark:border-neutral-700 bg-white/70 dark:bg-neutral-900/30 px-2.5 py-2">
                    <div class="flex items-center justify-between">

                        {{-- Fechas (izquierda) --}}
                        <div class="min-w-0 space-y-0.5">
                            <div class="inline-flex items-center gap-1 text-gray-800 dark:text-neutral-100">
                                ...
                                <span class="text-gray-500 dark:text-neutral-400 text-[10px]">Ini:</span>
                                <span class="tabular-nums text-[12px]">
                            ...
                            <div class="inline-flex items-center gap-1 text-gray-800 dark:text-neutral-100">
                                ...
                                <span class="text-gray-500 dark:text-neutral-400 text-[10px]">Venc:</span>
                                <span class="tabular-nums text-[12px]">
