...
<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-4">
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1.5 sm:mb-3 leading-tight">Presupuesto Total ({{ $dateLabel }})
        </p>
        ...
        <div class="mt-auto flex flex-col gap-2 relative z-10">
            @if ($isBoth || $moneda === 'BOB')
                <div
                    ...
                    <span class="{{ $valClassBase }} font-bold text-gray-900 dark:text-white tabular-nums">
                        {{ number_format((float) ($totales['presupuesto_total_bob'] ?? 0), 2, ',', '.') }}
                    </span>
                </div>
            @endif
            @if ($isBoth || $moneda === 'USD')
                <div class="flex items-center justify-between">
                    ...
                    <span class="{{ $valClassBase }} font-bold text-gray-900 dark:text-white tabular-nums">
                        {{ number_format((float) ($totales['presupuesto_total_usd'] ?? 0), 2, ',', '.') }}
                    </span>
                </div>
            @endif
        </div>
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1.5 sm:mb-3 leading-tight">Total Rendido ({{ $dateLabel }})</p>
            ...
            @if ($isBoth || $moneda === 'BOB')
                <div
                    ...
                    <span class="{{ $valClassBase }} font-bold text-emerald-600 dark:text-emerald-400 tabular-nums">
                        {{ number_format((float) ($totales['rendido_total_bob'] ?? 0), 2, ',', '.') }}
                    </span>
                </div>
            @endif
            @if ($isBoth || $moneda === 'USD')
                <div class="flex items-center justify-between">
                    ...
                    <span class="{{ $valClassBase }} font-bold text-emerald-600 dark:text-emerald-400 tabular-nums">
                        {{ number_format((float) ($totales['rendido_total_usd'] ?? 0), 2, ',', '.') }}
                    </span>
                </div>
            @endif
        </div>
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1.5 sm:mb-3 leading-tight">Total Saldo ({{ $historicalLabel }})
        </p>
    ...
    <div
        ...
        <p class="text-[11px] sm:text-sm font-medium text-gray-500 dark:text-neutral-400 mb-1 sm:mb-2 leading-tight">Presupuestos Activos
            ({{ $historicalLabel }})</p>
        <p class="mt-auto text-base sm:text-2xl font-bold text-indigo-600 dark:text-indigo-400 relative z-10">
