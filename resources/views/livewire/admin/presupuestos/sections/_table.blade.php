      ...
      <table wire:key="presupuestos-table" class="w-full table-fixed text-sm">
          <thead
              ...
              <tr class="text-left text-[11px] uppercase tracking-wider font-semibold">
                  ...
                  <th class="w-[35%] p-3 cursor-pointer select-none whitespace-nowrap hover:text-gray-900 dark:hover:text-white transition-colors"
                  ...
                  <th class="w-[14%] p-3 text-right cursor-pointer select-none whitespace-nowrap hover:text-gray-900 dark:hover:text-white transition-colors"
                  ...
                  <th class="w-[8%] p-3 text-center cursor-pointer select-none whitespace-nowrap hover:text-gray-900 dark:hover:text-white transition-colors"
